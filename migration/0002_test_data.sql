...
values ('dbb2edca-b8fb-4d9d-bb65-1461a6fed8c9', 'f218690b-4948-4217-8c76-7a433f533f42', 'Смоленск - щит России',
       ...
       ('afcfe1f3-2599-4a84-b814-f3bc12fb09d8', 'f218690b-4948-4217-8c76-7a433f533f42',
        'Смутное наследие: Смоленск во времена Великой Смуты',
        'Добро пожаловать в Смоленск, где история и приключения переплетаются в увлекательном квесте! Вы отправитесь в увлекательное путешествие во времена Великой Смуты, одного из самых турбулентных периодов в российской истории.\n\nВаше приключение начнется с посещения Смоленского кремля, знаменитой крепости, которая стала ареной героизма и жертвенности во времена Великой Смуты. Здесь вы узнаете о событиях, которые произошли в этой исторической крепости, и о роли Смоленска в том периоде.\n\nЗатем вас ожидают исторические памятники и места, связанные с этим периодом, включая памятники героям и места сражений. Вы окунетесь в атмосферу времен Великой Смуты, когда Смоленск оказался в центре событий и сопротивления.\n\nКвест \"Смутное наследие: Смоленск во времена Великой Смуты\" предоставляет вам уникальную возможность погрузиться в историю и наследие этого удивительного города, раскрывая множество тайн и открывая перед вами страницы российской истории. Готовы ли вы принять вызов и стать частью этого захватывающего путешествия во времени?',
        'route', extract(epoch from '3 hours'::interval) * 1000000000, '100');

insert into "quests_steps"("id", "quest_id", "order", "name", "place_type", "address", "phone", "email", "website", "schedule", "location")
values ('51219208-8c66-4320-ac02-d37f7998ef63', 'dbb2edca-b8fb-4d9d-bb65-1461a6fed8c9', 1, 'Русская старина', 'Музей', 'ул. Тенишевой 7, Смоленск', '+74812339585', 'museum@smolkrepost.ru', 'https://smolkrepost.ru', '[{"WeekDay":"Tue","FromTo":"10:00 – 18:00"},{"WeekDay":"Wed","FromTo":"10:00 – 18:00"},{"WeekDay":"Thu","FromTo":"10:00 – 18:00"},{"WeekDay":"Fri","FromTo":"10:00 – 17:00"},{"WeekDay":"Sat","FromTo":"10:00 – 18:00"},{"WeekDay":"Sun","FromTo":"10:00 – 18:00"}]', point(54.776799, 32.053039)),
       ('d297d769-cab7-4604-93a5-64101fe0df42', 'dbb2edca-b8fb-4d9d-bb65-1461a6fed8c9', 2, 'Смоленск - щит России', 'Музей', 'ул. Октябрьской Революции 3, Смоленск', '+74812339585', 'museum@smolkrepost.ru', 'https://smolkrepost.ru', '[{"WeekDay":"Tue","FromTo":"10:00 – 18:00"},{"WeekDay":"Wed","FromTo":"10:00 – 18:00"},{"WeekDay":"Thu","FromTo":"10:00 – 18:00"},{"WeekDay":"Fri","FromTo":"10:00 – 17:00"},{"WeekDay":"Sat","FromTo":"10:00 – 18:00"},{"WeekDay":"Sun","FromTo":"10:00 – 18:00"}]', point(54.777941, 32.044505)),
